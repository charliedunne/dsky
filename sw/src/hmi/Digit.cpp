...
void Digit::setColor(const Color fgColor, const Color bgColor)
{
  fgColor_ = fgColor;
  bgColor_ = bgColor;
}
...
void Digit::draw(std::vector<bool> seg)
{
  ...
  for (int i = 0; i < seg.size(); ++i)
  {
    ...
    // Set the color
    SDL_SetTextureColorMod(digitTx_, c.r(), c.g(), c.b());
    SDL_SetTextureAlphaMod(digitTx_, c.a());
    SDL_SetTextureColorMod(digitGlowTx_, c.r(), c.g(), c.b());
    SDL_SetTextureAlphaMod(digitGlowTx_, c.a());
